...
public class VideoView extends SurfaceView implements
	...
	public void setShowMode(int width, int height ,int mode){
		...
		logger.i("Screen width = " + widthScreen +" height = " + heightScreen);
	...
	private void openVideo() {
		...
		try {
			...
			logger.i("reset duration to -1 in openVideo");
			this.mDuration = -1;
...
//		setLayoutParams(localLayoutParams);
		LayoutParams param = new RelativeLayout.LayoutParams(paramInt1, paramInt2);
