...
import com.moon.android.model.Model_ad;
...
//		mAppMS
	...
	private void startVod(){
        ...
        try {
			Gson g=new Gson();
			mAdlist=g.fromJson(Adjson, new TypeToken<List<Model_ad>>(){}.getType());
		} catch (Exception e) {
...
//			setTitle();
	...
	private void getIntentData(){
		...
		proLogo=intent.getStringExtra("programLogo");
		Programjson=intent.getStringExtra("mVodProgram");
		Adjson=intent.getStringExtra("Adjson");
	...
	private void initWidget() {
		...
		mOSDAd=new OSDAd(mContainer);
		mOSDManager = new OSDManager();
		
		
		mOSDManager.addOSD(OSDManager.OSD_AD,mOSDAd);
